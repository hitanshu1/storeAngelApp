...
class CourierDeliveryCustomerDetails extends StatelessWidget {
  ...
  CourierDeliveryCustomerDetails({this.clientDetails,this.orderByStore});
  @override
  Widget build(BuildContext context) {
    return CustomFiveWidgetsTile(
      trailingOneBackGroundColor: AppColors.blueGradient,
        trailingOne: Center(
          child: Icon(StoreangelIcons.change_to_courier_profile_screen,color: AppColors.whiteColor,
