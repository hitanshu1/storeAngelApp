...
class MoreStoreWidget extends StatelessWidget {
  @override
    ...
    return Consumer<MyStoreViewModel>(builder: (context,model,child){
      return SliverList(
          delegate: SliverChildBuilderDelegate(
                ...
                child: GestureDetector(
                  ...
                  child: CustomFiveWidgetsTile(
                      trailingOne: InkWell(
                        ...
                        onTap: (){
                          model.onAddStore(model.unselectedStores[index]);
                        },
                      ),
                      ...
                      imageUrl: model.unselectedStores[index].image,
                      middleWidget: Column(
                        ...
                        children: [
                          ...
                          SizeConfig.verticalSpaceSmall(),
                          Text(model.unselectedStores[index].name,
                          ...
                          Text(model.unselectedStores[index].twoLineAddressWithoutName,
            ...
            childCount: model.unselectedStores.length,
          ));
    });
  }
}
