...
/// See also:
///
///  * [CustomScrollView], which integrates the [CustomSliverAppBar] into its
///    scrolling.
...
class CustomSliverAppBar extends StatefulWidget {
  ...
  ///
  /// When using [CustomSliverAppBar.flexibleSpace], the [CustomSliverAppBar.expandedHeight]
  /// must be large enough to accommodate the [CustomSliverAppBar.flexibleSpace] widget.
  ///
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _SliverAppBarDelegate(
          ...
          brightness: widget.brightness??Provider.of<AppThemeViewModel>(context).themeData==AppTheme.dark?Brightness.dark: Brightness.light,
